...
d.chi_phi_thue + SUM(ifnull(hop_dong_chi_tiet.so_luong,0) * ifnull(dich_vu_di_kem.gia,0)) AS tong_tien
FROM khach_hang c
...
SELECT h.ma_hop_dong, h.ngay_lam_hop_dong, h.ngay_ket_thuc, h.tien_dat_coc, SUM(c.so_luong) AS so_luong_dich_vu_di_kem
FROM hop_dong h
